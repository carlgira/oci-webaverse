...
output "instance_public_ip" {
  ...
  ssh tunnel => 
    ssh -i server.key -L 3000:localhost:3000 -L 8080:localhost:8080 ubuntu@${oci_core_instance.instance.public_ip}

  Webaverse => https://localhost:3000
  CodeServer => http://localhost:8080/?folder=/home/ubuntu/webaverse
